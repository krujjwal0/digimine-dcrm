      ...
      <div className="container h-full min-h-full relative z-10">
        <div className="flex justify-end flex-wrap h-full  min-h-full items-center">
          <div className="card bg-white shadow-lg rounded-3xl py-10 px-10 max-w-xl w-1/2">
              ...
              <img src={LoginImage} alt="LoginImage" className="w-72 mx-auto mb-5"/>
              </div>
              <h1 className="text-center font-bold font-sans text-3xl mb-8 text_blue mt-16">Login</h1>
              ...
              />
              <p className="text-right mb-32 mt-2 font-sans text-red-500">Error Message</p>
              {/* <TextField
                name="password"
                type="password"
                placeholder="***"
              ...
              <Button className="bg_red mx-auto  font-bold login_btn  w-60 h-14 rounded-3xl my-5 ">
                Login
              </Button>
