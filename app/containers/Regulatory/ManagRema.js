    ...
    <div>
      <div className=" mt-8   w-[100%] ">
        <div className="flex  mt-2 mb-6">
          <Typography className="text-[18px] w-full font-sans font-bold  text-[#132B6B] pl-9" style={{fontWeight: '500'}}>
            Management Remarks
          </Typography>
        ...
        <Grid className="ml-10 w-11/12" style={{ border: '2px solid #EAEAEA', borderRadius: '10px' }}>
        ...
        <div className="flex justify-between mt-8 mr-12 ">
          <Typography className="text-[18px] font-sans  text-[#132B6B] pl-9" style={{fontWeight: '600'}}>
        ...
        <div className="mt-16">
          <Typography className="text-[18px] font-sans text-[#132B6B] pl-10  " style={{fontWeight: '500'}}>
            Remarks
          </Typography>
          <p className=" text-[14px] font-sans text-[#000000] mt-[12px] pl-10  pb-4" style={{lineHeight: '24px', fontWeight: '400'}}>
          ...
          <p className=' pl-10 text-[11px] font-sans' 
          style={{color: '#9FA1A1',fontWeight: '600', lineHeight: '14.3px', textTransform: 'capitalize' }}>Oct 24, 2019</p>
        </div>


<div className='mt-14 ml-10 w-11/12 h-72 rounded-lg mb-10 font-sans' style={{ backgroundColor: '#F7F8FA' }}>
<Tabs
            value={value}
          ...
          >
            <Tab className="font-sans " style={{color: '#132B6B', fontWeight: '600', fontFamily: 'sans-serif'}} label="Reviewer Feedback" {...a11yProps(0)} />
            <Tab  className="font-sans" style={{color: '#132B6B', fontWeight: '600'}} label="Lead Reviewer Feedback" {...a11yProps(1)} />
          </Tabs>
        ...
        >
          ...
          <TabPanel value={value} index={0} className="ml-2 mt-6">
            <div className="mt-8">
              ...
              <p className="text-[14px] font-sans text-[#000000] mt-[8px] pb-4" style={{lineHeight: '24px', fontWeight: '400'}}>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec
                tincidunt velit vel nisl eleifend suscipit. Pellentesque nisl
              ...
              style={{color: '#9FA1A1',fontWeight: '600', lineHeight: '14.3px', textTransform: 'capitalize' }}
              >Oct 24, 2019</p>
            </div>
          </TabPanel>
