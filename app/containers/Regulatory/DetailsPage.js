      ...
      <div className=" mt-4  w-full">
          ...
          <div className="mt-3 mr-24">
            <div className="">
              ...
              <span
                ...
                style={{ backgroundColor: '#ECEDEF',fontSize: '14px',
                borderRadius: '4px', }}
              >
                5(4)
              </span>
        ...
        <div className="flex justify-end mt-3 mr-28">
          <span className="flex">
            ...
            />
            <p className="font-sans" style={{fontWeight: '500', fontSize: '10px'}}>Selected</p>
          </span>
          <span className="flex">
            <FiberManualRecordIcon
              className="font-sans"
            ...
            />
            <p className="font-sans" style={{fontWeight: '500', fontSize: '10px'}}>Completed</p>
          </span>
          <span className="flex">
            <FiberManualRecordIcon
              className="font-sans"
            ...
            />
            <p className="font-sans" style={{fontWeight: '500', fontSize: '10px'}}>Incomplete</p>
          </span>
        </div>
        <Grid
        ...
        >
          ...
          >
            <Typography className="text-[14px] font-sans font-semibold text-[#132B6B] ">
              ...
              <span
                ...
                style={{ backgroundColor: '#8EF4D2', borderRadius: '4px', width: '10px', height: '1px' }}
              >
                5(4)
              </span>
            </Typography>
          ...
          <div className="mt-4">
            <Typography className="text-[18px] font-sans font-extrabold  text-[#132B6B]  pl-10" style={{fontWeight: "500"}}>
              Responsibility
            </Typography>
            <p className="text-[14px] font-sans font-normal text-[#000000] mt-[8px] pl-10 pb-4">
              Owner/Agent/Manager
        ...
        <div className="mt-16">
          <Typography className="text-[10px] font-sans text-[#000000]  pl-10 pb-0" style={{fontWeight: '400'}}>
